...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Mrcutex1/Vasu",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Nairobimusicupdate")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+pyc-zUhxkoUyMTI1")
